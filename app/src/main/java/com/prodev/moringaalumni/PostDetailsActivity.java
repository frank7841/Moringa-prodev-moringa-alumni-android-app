...
import com.prodev.moringaalumni.Adapters.AdapterComments;
import com.prodev.moringaalumni.Models.ModelComments;
...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    private Uri saveImgeToShare(Bitmap bitmap) {
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri= FileProvider.getUriForFile(this,"com.prodev.moringaalumni.fileprovider",file);
